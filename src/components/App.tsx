...
function TabContent({ profile, projects = [], experiences }: AppProps) {
    ...
    return <Home profile={profile} projects={projects} experiences={experiences} tabParam={tabIndex} />;
}

export default function App({ profile, projects = [], experiences = [] }: AppProps) {
    return (
        <BrowserRouter>
            <Routes>
                ...
                {/* Route for each tab */}
                <Route path="/:tab" element={<TabContent profile={profile} projects={projects} experiences={experiences} />} />
            </Routes>
        </BrowserRouter>
    );
}